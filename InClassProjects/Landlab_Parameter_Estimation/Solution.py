...
K_sps = np.linspace(1.5E-4, 2.5E-4, 11)
#K_hss = np.linspace(0.5E-1, 1.5E-1, 11)
ncells_side = 10 # number of raster cells on each side
dxy  = 5000 # side length for raster model cells [m]
...
#plt.plot(0.1, 2E-4, 'ko') # This is the solution
#plt.yscale('log')
#plt.xscale('log')
plt.colorbar()
