...
\lstinputlisting{code/snowball_imperative.py}
...
\lstinputlisting{code/snowball_imperative_functions.py}
...
Module:
\lstinputlisting{code/snowball_functions_module.py}

Driver:
\lstinputlisting{code/snowball_functions_module_driver.py}
...
Module with class:
\lstinputlisting{code/snowball.py}

Driver:
\lstinputlisting{code/mysnowball.py}
...
\lstinputlisting{code/randomWalk1D_before_class.py}
